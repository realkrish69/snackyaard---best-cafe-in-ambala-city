...
const Vibes: React.FC = () => {
  return (
    <section
      id="vibes"
      className="py-24 bg-[#0a1f16] relative overflow-hidden z-10"
    >
      <div className="absolute inset-0 z-0 opacity-20">
        <img
          src="https://picsum.photos/1920/1080?random=40"
          alt="Vibes Background"
        ...
        <div className="flex flex-col lg:flex-row items-center gap-20">
          ...
          <div className="lg:w-1/2 space-y-8 order-1 lg:order-2">
            ...
            <h2 className="text-4xl md:text-5xl font-serif font-bold italic leading-tight">
              Savor the Aesthetic <br />
              <span className="text-gold">Vibes & Mocktails</span>
            </h2>

            <p className="text-gray-400 text-lg leading-relaxed">
              Snackyaard isn't just about food; it's an experience. Our curated
              selection of mocktails and cafe favorites are designed to
              complement your favorite spicy momos and savory Chinese snacks.
            </p>
