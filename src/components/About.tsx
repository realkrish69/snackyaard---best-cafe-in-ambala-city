        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="lg:w-1/2 space-y-8 animate-fade-in-right text-left">
            ...
            <div className="inline-flex items-center text-gold text-sm tracking-widest uppercase font-bold">
              <ChiliIcon />
              <span className="ml-2">The Team Behind the Experience</span>
            </div>

            <h2 className="text-4xl md:text-5xl font-serif font-bold italic leading-tight text-white">
              Behind the <span className="text-gold">Magic</span>
            </h2>
            ...
            <div className="space-y-6 text-gray-400 leading-relaxed text-lg">
              <p>
                ...
                Each momo is hand-wrapped, each sauce is simmered for hours,
                and every plate is inspected for perfection before it reaches
                your table.
              </p>
            </div>
